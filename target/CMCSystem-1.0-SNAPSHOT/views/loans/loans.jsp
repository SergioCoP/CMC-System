...
<html>
<head>
    <title>Solicitud Credito | CMC</title>
...
<div class="main-content">
    ...
    <table class="table">
        ...
        <tbody>
        <c:forEach items="${ listLoans}" var="loan" ><!--iterar cada usuario-->
        <tr>
            <td>${loan.id}</td>
            <td>${loan.member} </td>
            <td>${loan.id.credit}</td><!--datos del bean person-->
            <td>${loan.id.amount}</td>
            <td>${loan.id.period}</td>
            <td>${loan.id.date}</td>
            <th>${loan.id.aval1}</th>
            <th>${loan.id.aval2}</th>
            <td>
